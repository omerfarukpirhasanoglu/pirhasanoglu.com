  ...
  return (
    <div className="max-w-6xl mx-auto w-full flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Proje Kartı 1 */}
        <div className="glass-panel rounded-sm p-1 border border-white/5 group hover:border-accent/30 hover:shadow-2xl hover:shadow-accent/10 transition-all duration-500 animate-reveal delay-400 relative overflow-hidden">
          {/*glow*/}
          ...
          <div className="bg-surface/50 rounded-sm p-6 md:p-8 flex flex-col md:flex-row gap-8 items-start md:items-center relative z-10">
            ...
            {/* Buttons*/}
            <Link href="/dashboard/tool-1" className="shrink-0 w-full md:w-auto flex items-center justify-center gap-2 bg-linear-to-r from-[#f75f5f] to-[#ffd44f] text-[#1a0808] px-6 py-3 rounded-sm font-semibold hover:opacity-90 transition-colors duration-250">
              Modeli İncele
